...
class AnalizeTest {
    ...
    @Test
    void whenTwoAddedAndOneChanged() {
        User u1 = new User(1, "A");
        User u2 = new User(2, "B");
        User u3 = new User(3, "C");
        Set previous = Set.of(u1, u2, u3);
        Set current = Set.of(new User(1, "AA"), u2, u3, new User(4, "D"), new User(5, "E"));
        assertThat(Analize.diff(previous, current)).isEqualTo(new Info(2, 1, 0));
    }

    @Test
    void whenOneDeletedAndTwoChanged() {
        User u1 = new User(1, "A");
        User u2 = new User(2, "B");
        User u3 = new User(3, "C");
        Set previous = Set.of(u1, u2, u3);
        Set current = Set.of(new User(2, "BB"), new User(3, "CC"));
        assertThat(Analize.diff(previous, current)).isEqualTo(new Info(0, 2, 1));
    }
